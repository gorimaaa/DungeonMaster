...
```
cd existing_repo
git remote add origin https://gitlab-dpt-info-sciences.univ-rouen.fr/m1gil/dungeon-master.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-dpt-info-sciences.univ-rouen.fr/m1gil/dungeon-master/-/settings/integrations)
